...
StoreItem.add({
  ...
  category: { type: Types.Relationship, ref: 'Category', initial: true, required: true, index: true },
  price: { type: Number, required: true, initial: true, index: true },
  currency: {
    type: Types.Select,
  ...
  itemDescription: { type: Types.Html, wysiwyg: true, initial: true },
});
