...
class TableViewItemsBrowser extends React.Component {
  ...
  renderMedia(data) {
    if (data.type === 'video') {
      ...
      return <div style={styles.imageContainer(url)} />;
  ...
  render() {
    ...
    const thSortIcon = (field) => {
      ...
      return (
        <FontIcon className="material-icons" style={styles.sortIconStyles}>
